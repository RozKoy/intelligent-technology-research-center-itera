	...
	<div class="font-poppins w-full">
		...
		<div class="header bg-gold w-full rounded-b-3xl shadow-md">
			...
			<ul class="header-navbar flex flex-wrap items-center justify-center p-2 w-full text-center text-xs">
				...
				<!-- Dropdown menu -->
				<div id="dropdownHover" class="z-50 hidden bg-gold divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
				    <ul class="text-sm text-gray-700 dark:text-gray-200 text-xs" aria-labelledby="dropdownHoverButton">
				      <li>
				        <a href="/Profil#sejarah" class="block bg-white py-2 m-2 w-24 rounded-md shadow hover:text-gold">Sejarah</a>
				      </li>
				      <li>
				        <a href="/Profil#visidanmisi" class="block bg-white py-2 m-2 w-24 rounded-md shadow hover:text-gold">Visi & Misi</a>
				      </li>
				      <li>
				...
				<!-- Dropdown menu -->
				<div id="dropdownHover_1" class="z-50 hidden bg-gold divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
				    <ul class="text-sm text-gray-700 dark:text-gray-200 text-xs" aria-labelledby="dropdownHoverButton">
				      <li>
