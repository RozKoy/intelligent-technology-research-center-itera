...
<div class="w-full min-h-screen">
	...
	<div id="sejarah flex flex-col items-center justify-center">
		...
		<div class="p-6">
		<div class="flex flex-wrap-reverse sm:flex-nowrap justify-center mx-auto max-w-[1000px]">
	...
	<div id="visidanmisi">
        ...
        <div class="p-6">
		<div class="mx-auto flex flex-col items-center max-w-[1000px]">
