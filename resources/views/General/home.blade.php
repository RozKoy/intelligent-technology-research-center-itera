		    ...
		    <div class="relative aspect-video overflow-hidden rounded shadow">
				...
				@else
					@foreach ($banner as $item)
			            ...
			            <div class="absolute w-full -translate-x-1/2 bottom-0 py-2.5 overflow-hidden px-5 left-1/2 bg-black/30 h-auto text-white font-bold text-3xl">
	...
	<div class="berita">
		...
		<div class="flex flex-wrap items-center justify-center p-5">
			...
			@if ($berita -> isNotEmpty())
				...
				<div class="w-4/6 sm:w-64 bg-white border border-gray-200 rounded-lg shadow m-1.5">
